...
import DelCheck from "../DelCheck/DelCheck";
...
class ToDoList extends PureComponent {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      !prevProps.removeSelectedTasksSuccess &&
      this.props.removeSelectedTasksSuccess
    ) {
      this.setState({
        selectedTasks: new Set(),
        showConfirm: false,
      ...
      <>
        ...
        <div className={styles.back}>
          <div className={styles.list}>
            ...
            <div className={styles.tasksWrapper}>{tasks}</div>
            {!!tasks.length && (
              <button
                className={styles.btn}
