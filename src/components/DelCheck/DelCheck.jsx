...
class DelCheck extends Component {
  ...
  render() {
    ...
    return (
      <div
        className={checked ? styles.checked + " " + styles.line : styles.line}
      >
        <h3>
        ...
        {tasks.description && <p>{trimString(tasks.description, 50)} </p>}
        ...
        <div className={styles.delcheck}>
          {tasks.status === "active" ? (
            <button
              ...
              disabled={disabled}
              onClick={() =>
                this.props.changeStatus({ status: "done" }, tasks._id)
              }
            >
            ...
            <button
              ...
              disabled={disabled}
              onClick={() =>
                this.props.changeStatus({ status: "active" }, tasks._id)
              }
            >
          ...
          <input type="checkbox" onClick={this.checkHandler} key={tasks._id} />
        </div>
      </div>
    );
  }
